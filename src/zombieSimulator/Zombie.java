...
public class Zombie {
	...
	public void takeStep() {
		...
		// dok³adnie 8 otaczaj¹cych go kratek, razem ze wspó³rzêdnymi i iloœci¹
		// ludzi wewn¹trz
		...
		// wartoœæ parametru true okreœla aby umieœciæ w liscie tak¿e aktualny
		// cell w ktorym zombie siê znajduje
		List<GridCell<Human>> gridCells = nghCreator.getNeighborhood(true);
		// shuffle przemiesza listê by w przypadku gdy wszêdzie jest taka sama
	...
	public void moveTo(GridPoint targetPoint) {
		if (targetPoint.equals(grid.getLocation(this))) {
			return;
		} else { // idziemy w tym kierunku tylko jeœli nie jest to ju¿ nasz
					// aktualna lokacja (komórka grid'a)
